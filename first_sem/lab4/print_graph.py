...
def draw_result(T_list_list, h_x, h_t):
    ...
    plt.legend()
    '''
    y = np.array(get_T_list_for_cur_x(T_list_list, 0.05, h_x))
    plt.plot(x, y, label=('x = 0.05'))
    plt.legend()

    y = np.array(get_T_list_for_cur_x(T_list_list, 0.1, h_x))
    plt.plot(x, y, label=('x = 0.1'))
    plt.legend()

    y = np.array(get_T_list_for_cur_x(T_list_list, 0.2, h_x))
    plt.plot(x, y, label=('x = 0.2'))
    plt.legend()

    y = np.array(get_T_list_for_cur_x(T_list_list, 0.5, h_x))
