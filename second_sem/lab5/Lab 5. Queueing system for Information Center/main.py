...
class MainWindow(QWidget):
    ...
    def on_pushButton_model_clicked(self):
        lost_clients, lost_clients_p = modeller.event_based_modelling(**self.parameters)
        self._ui.le_lost_clients.setText('{:d}'.format(lost_clients))
        self._ui.le_lost_clients_p.setText('{:.4f}'.format(lost_clients_p))
