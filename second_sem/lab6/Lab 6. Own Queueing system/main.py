...
class MainWindow(QWidget):
    ...
    def on_pushButton_clicked(self):
        ...
        u.le_ev0_wt_q.setText('{:2d}'.format(devices[2].max_queue_size))
        u.le_ev1_wt_q.setText('{:2d}'.format(devices[3].max_queue_size))
        u.le_ev2_wt_q.setText('{:2d}'.format(devices[4].max_queue_size))
        u.le_cid0_wt_q.setText('{:2d}'.format(devices[5].max_queue_size))
        u.le_cid1_wt_q.setText('{:2d}'.format(devices[6].max_queue_size))
        u.le_cid2_wt_q.setText('{:2d}'.format(devices[7].max_queue_size))
        u.le_cid3_wt_q.setText('{:2d}'.format(devices[8].max_queue_size))
        u.le_pcd0_wt_q.setText('{:2d}'.format(devices[9].max_queue_size))
        u.le_pcd1_wt_q.setText('{:2d}'.format(devices[10].max_queue_size))
    ...
    def start_modelling(self, pg0_m, pg1_m, pg0_d, pg1_d,
                        ...
                        pcd0_m, pcd1_m, pcd0_d, pcd1_d, c_count):
        ...
        for p in passport_control: p.add_receiver(plane)

        devices = passengers + entrance + checkin + passport_control + (plane,)
